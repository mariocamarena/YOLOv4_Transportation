...
source_dir = 'C:/Users/Mario/OneDrive/Desktop/YOLOv4-PyTorch-Transportation/data/custom/val_images/'
train_txt_dir = 'C:/Users/Mario/OneDrive/Desktop/YOLOv4-PyTorch-Transportation/data/custom/'

# find all .png files in the source directory
png_files = glob.glob(source_dir + '/*.png')

# open the train.txt file in write mode
with open(os.path.join(train_txt_dir, 'val.txt'), 'w') as f:
    ...
    for file_path in tqdm(png_files, desc="Processing files", unit="file"):
        ...
        new_path = f'data/custom/val_images/{base_name}'
